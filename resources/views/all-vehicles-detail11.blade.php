        ...
        <div class="row">
            <div class="col-12">
                <div class="breadcrumb-content text-center">
                    <h2>LAMBORGHINI <span>URUS</span></h2>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{route('home')}}">Home</a></li>
                            <li class="breadcrumb-item"><a href="{{route('all_vehicles')}}">All Vehicles</a></li>
                            <li class="breadcrumb-item active" aria-current="page">LAMBORGHINI URUS</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="section-title mb-20">
                    <h2>AED <span>4,500</span> <small><small> / Day</small></small></h2>
                </div>
                <table id="specs">
                    <tr>
                        <th><b>Engine</b></th>
