        ...
        <div class="layout-px-spacing">
            <div class="row layout-top-spacing" id="cancel-row">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('llc_company_formation')}}">LLC Company Formation</a></li>
                    ...
                    <div style="background: black;">
                        <div class="row">
                            <div class="col-md-6 mt15 pl30">
                                <h5 class="text-white">Update Content - {{$llc_company_formation->name}}</h5>
                            </div>

                            <div class="col-md-6 text-right">
                                <a href="{{route('llc_company_formation')}}" class="btn btn-danger mb-2 mr-4 ml-3 mt-2"> 
                    ...
                    <div class="widget-content widget-content-area">
                        ...
                        <div id="toggleAccordion">
                            <br>
                            @foreach($llc_company_formation->details as $key => $detail)
                                <form action="{{route('llc_company_formation.update', [$llc_company_formation->id, $detail->id]) }}" method="POST">
                                @csrf
