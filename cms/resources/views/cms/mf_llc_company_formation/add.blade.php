...
@section('title', 'LLC Company Formation')
@section('top-styles')
        ...
        <div class="layout-px-spacing">
            <div class="row layout-top-spacing" id="cancel-row">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('mf_llc_company_formation')}}">LLC Company Formation</a></li>
                    <li class="breadcrumb-item active" aria-current="page">{{$isEdit ? 'Edit' : 'Add'}}</li>
                </ol>
                
                        
                <form action="{{ $isEdit ? route('mf_llc_company_formation.update', [$mf_llc_company_formation->id]) : route('mf_llc_company_formation.store') }}" method="POST">
                    @csrf
                    @if ($isEdit)
                    ...
                    <div style="background: black;">
                        <div class="row">
                            <div class="col-md-6 mt15 pl30">
                                <h5 class="text-white">LLC Company Formation / {{$isEdit ? 'Edit' : 'Add'}}</h5>
                            </div>

                            <div class="col-md-6 text-right">
                                <a href="{{route('mf_llc_company_formation')}}" class="btn btn-danger"> 
                    ...
                    <div class="widget-content widget-content-area">
                        <div class="form-row mb-4">
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" name="name" value="{{ $mf_llc_company_formation->name ?? old('name') ?? null }}"
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" name="meta_title" value="{{ $mf_llc_company_formation->meta_title ?? old('meta_title') ?? null }}"
                            ...
                            <div class="form-group col-md-8">
                                ...
                                <input type="text" name="meta_description" value="{{ $mf_llc_company_formation->meta_description ?? old('meta_description') ?? null }}"
                                ...
                                <div class="addMore">
                                    <div class="addmore_cont">
                                        <div class="addMore_btn">
                                            @if($isEdit)
                                                @foreach($mf_llc_company_formation->details as $key => $detail)
