            ...
            <div class="row layout-top-spacing" id="cancel-row">
                <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">LLC Company Formation</li>
                    </ol>
                    <div class="widget-content widget-content-area br-6">
                        <div style="background: black;">
                            <div class="row">
                                <div class="col-md-6 mt15 pl30">
                                    <h5 class="text-white">LLC Company Formation</h5>
                                </div>
                                @can('mf_llc_company_formation-add')
                                    <div class="col-md-6 text-right">
                                        <a href="{{ route('mf_llc_company_formation.create') }}" class="btn btn-danger mb-2 mr-4 ml-3 mt-2">Add</a>
                                    </div>
                                @endcan
                            </div>
                        </div>
...
@include('cms.mf_llc_company_formation.includes.mf-llc-company-formation-js')
@endsection
