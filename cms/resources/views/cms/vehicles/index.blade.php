                        ...
                        <div style="background-color: #282a33;">
                            <div class="row">
                                <div class="col-md-6 mt15 pl30">
                                    <h5 class="text-white">Vehicles</h5>
                                </div>
                                    <div class="col-md-6 text-right">
                                        <a href="{{ route('vehicle.create') }}" class="btn btn-danger mb-2 mr-4 ml-3 mt-2">Add Vehicle</a>
                                    </div>
                            </div>
                        </div>
                        <br>
...
@include('cms.vehicles.includes.vehicles-js')
@endsection
