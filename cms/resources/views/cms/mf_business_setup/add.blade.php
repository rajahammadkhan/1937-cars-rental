        ...
        <div class="layout-px-spacing">
            <div class="row layout-top-spacing" id="cancel-row">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('mf_business_setup')}}">Business Setup</a></li>
                    <li class="breadcrumb-item active" aria-current="page">{{$isEdit ? 'Edit' : 'Add'}}</li>
                </ol>
                
                        
                <form action="{{ $isEdit ? route('mf_business_setup.update', [$mf_business_setup->id]) : route('mf_business_setup.store') }}" method="POST">
                    @csrf
                    @if ($isEdit)
                    ...
                    <div style="background: black;">
                        <div class="row">
                            <div class="col-md-6 mt15 pl30">
                                <h5 class="text-white">Business Setup / {{$isEdit ? 'Edit' : 'Add'}}</h5>
                            </div>

                            <div class="col-md-6 text-right">
                                <a href="{{route('mf_business_setup')}}" class="btn btn-danger"> 
                    ...
                    <div class="widget-content widget-content-area">
                        <div class="form-row mb-4">
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" name="name" value="{{ $mf_business_setup->name ?? old('name') ?? null }}"
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" name="meta_title" value="{{ $mf_business_setup->meta_title ?? old('meta_title') ?? null }}"
                            ...
                            <div class="form-group col-md-8">
                                ...
                                <input type="text" name="meta_description" value="{{ $mf_business_setup->meta_description ?? old('meta_description') ?? null }}"
                                ...
                                <div class="addMore">
                                    <div class="addmore_cont">
                                        <div class="addMore_btn">
                                            @if($isEdit)
                                                @foreach($mf_business_setup->details as $key => $detail)
