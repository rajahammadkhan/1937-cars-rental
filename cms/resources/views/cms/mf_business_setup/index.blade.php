                        ...
                        <div style="background: black;">
                            <div class="row">
                                <div class="col-md-6 mt15 pl30">
                                    <h5 class="text-white">Business Setup</h5>
                                </div>
                                @can('mf_business_setup-add')
                                    <div class="col-md-6 text-right">
                                        <a href="{{ route('mf_business_setup.create') }}" class="btn btn-danger mb-2 mr-4 ml-3 mt-2">Add</a>
                                    </div>
                                @endcan
                            </div>
                        </div>
...
@include('cms.mf_business_setup.includes.mf-business-setup-js')
@endsection
