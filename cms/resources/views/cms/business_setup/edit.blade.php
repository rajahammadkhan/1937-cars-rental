        ...
        <div class="layout-px-spacing">
            <div class="row layout-top-spacing" id="cancel-row">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('business_setup')}}">Business Setup</a></li>
                    ...
                    <div style="background: black;">
                        <div class="row">
                            <div class="col-md-6 mt15 pl30">
                                <h5 class="text-white">Update Content - {{$business_setup->name}}</h5>
                            </div>

                            <div class="col-md-6 text-right">
                                <a href="{{route('business_setup')}}" class="btn btn-danger mb-2 mr-4 ml-3 mt-2"> 
                    ...
                    <div class="widget-content widget-content-area">
                        ...
                        <div id="toggleAccordion">
                            <br>
                            @foreach($business_setup->details as $key => $detail)
                                <form action="{{route('business_setup.update', [$business_setup->id, $detail->id]) }}" method="POST">
                                @csrf
