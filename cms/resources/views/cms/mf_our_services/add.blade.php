        ...
        <div class="layout-px-spacing">
            <div class="row layout-top-spacing" id="cancel-row">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('mf_our_service')}}">Our Services</a></li>
                    <li class="breadcrumb-item active" aria-current="page">{{$isEdit ? 'Edit' : 'Add'}}</li>
                </ol>
                
                        
                <form action="{{ $isEdit ? route('mf_our_service.update', [$mf_our_service->id]) : route('mf_our_service.store') }}" method="POST">
                    @csrf
                    @if ($isEdit)
                    ...
                    <div style="background: black;">
                        <div class="row">
                            <div class="col-md-6 mt15 pl30">
                                <h5 class="text-white">Our Services / {{$isEdit ? 'Edit' : 'Add'}}</h5>
                            </div>

                            <div class="col-md-6 text-right">
                                <a href="{{route('mf_our_service')}}" class="btn btn-danger"> 
                    ...
                    <div class="widget-content widget-content-area">
                        <div class="form-row mb-4">
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" name="name" value="{{ $mf_our_service->name ?? old('name') ?? null }}"
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" name="meta_title" value="{{ $mf_our_service->meta_title ?? old('meta_title') ?? null }}"
                            ...
                            <div class="form-group col-md-8">
                                ...
                                <input type="text" name="meta_description" value="{{ $mf_our_service->meta_description ?? old('meta_description') ?? null }}"
                            ...
                            <!-- <div class="form-group col-md-12">
                                ...
                                <input type="text" value="" data-role="tagsinput" class="tags" placeholder="Add tags" />
                            </div> -->
                                ...
                                <div class="addMore">
                                    <div class="addmore_cont">
                                        <div class="addMore_btn">
                                            @if($isEdit)
                                                @foreach($mf_our_service->details as $key => $detail)
        ...
        $(document).ready(function() {
            ...
            $(document).on('click' , '.add_more1' , function(){
                ...
                `<div class="row addmore_cont1 ml30">
                    ...
                    <div class="form-group col-md-11">
                        <input type="text" name="tab_name[00${num++}]" value=""
                            class="form-control" placeholder="Enter Tab Name...">
                        @if ($errors->has('name'))
                            <div class="error">{{ $errors->first('name') }}</div>
                        @endif
