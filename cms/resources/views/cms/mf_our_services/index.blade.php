                    ...
                    <div class="widget-content widget-content-area br-6">
                        <div style="background: black;">
                            <div class="row">
                                ...
                                @can('mf_our_services-add')
                                    <div class="col-md-6 text-right">
                                        <a href="{{ route('mf_our_service.create') }}" class="btn btn-danger mb-2 mr-4 ml-3 mt-2">Add Service</a>
                                    </div>
                                @endcan
                            </div>
                        </div>
...
@include('cms.mf_our_services.includes.mf-our-service-js')
@endsection
