    ...
    <div id="content" class="main-content">
        <div class="layout-px-spacing">
            <div class="row layout-top-spacing" id="cancel-row">
                ...
                <form action="{{route('mf_our_service.header_content_update',[$mf_our_service->id])}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="_method" value="put">
                    <div style="background: black;">
                        <div class="row">
                            <div class="col-md-6 mt15 pl30">
                                <h5 class="text-white">Our Services / Header Content</h5>
                            </div>
                    ...
                    <div class="widget-content widget-content-area">
                        <div class="form-row mb-4">
                            <div class="col-md-12">
                                ...
                                <div class="images">
                                    <div class="photo">
                                        <img src="{{url('')}}/uploads/{{$mf_our_service->top_image ?? 'placeholder.png'}}" id="preview" class="img-thumbnail browse">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12 mt30">
                                ...
                                <textarea cols="200" class="summernote" name="top_content">{!! $mf_our_service->top_content !!}</textarea>
                            </div>
                        </div>
                    </div>
                </form>
