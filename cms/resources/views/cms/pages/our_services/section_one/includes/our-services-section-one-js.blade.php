<script type="text/javascript">
    $(document).ready(function() {
      ...
      var table = $('#ourServicesSectionOneDatatable').DataTable({
          processing: true,
          serverSide: true,
          ajax: "{{ route('our_services_section_one.datatable') }}",
          "columns": [{
                  "data": "id",
                  "defaultContent": ""
              },
          ...
          "columnDefs": [{
              ...
              },
              {
                  ...
                  "render": function(data, type, row, meta) {
                      ...
                      var edit = "{{ route('our_services_section_one.edit', [':id']) }}";
          ...
          $('.section-four-status').change(function () {
            ...
            axios
              .post('{{route("our_services_section_one.status")}}', {
                _token: '{{csrf_token()}}',
                _method: 'patch',
                id: id,
                status: status,
          ...
          $('.section-four-delete').click(function () {
            ...
            swal({
              ...
              if (result.value) {
              axios
                .post('{{route("our_services_section_one.destroy")}}', {
                  _method: 'delete',
                  _token: '{{csrf_token()}}',
                  deleteId: deleteId,
                })
