        ...
        <div class="layout-px-spacing">
            <div class="row layout-top-spacing" id="cancel-row">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('other_pages')}}">Pages</a></li>
                    <li class="breadcrumb-item"><a href="{{route('other_pages.our_services')}}">Our Services</a></li>
                    <li class="breadcrumb-item"><a href="{{route('other_pages.our_services')}}">Section One</a></li>
                    <li class="breadcrumb-item active" aria-current="page">{{$isEdit ? 'Edit' : 'Add'}}</li>
                </ol>
                
                        
                <form action="{{ $isEdit ? route('our_services_section_one.update', [$our_services_section_one->id]) : route('our_services_section_one.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @if ($isEdit)
                    ...
                    <div style="background: black;">
                        <div class="row">
                            ...
                            <div class="col-md-6 text-right">
                                <a href="{{route('other_pages.our_services')}}" class="btn btn-danger"> 
                    ...
                    <div class="widget-content widget-content-area">
                        <div class="form-row mb-4">
                            <div class="col-md-4">
                                <label>Image <small>( Dimension : 606 x 408 )</small> <span class="text-danger"> *</span> </label>
                                <input {{!$isEdit ? 'required' : null}} type="file" name="image"  class="file" accept="image/*" >
                                <div class="images">
                                    <div class="photo">
                                        <img src="{{url('')}}/uploads/{{$our_services_section_one->image_one ?? 'placeholder-small.jpg'}}" id="preview" class="img-thumbnail browse">
                                    </div>
                                    @if ($errors->has('image'))
                            ...
                            <div class="col-md-8 mt10">
                                ...
                                <textarea required cols="200" class="summernote" name="description">{!! $our_services_section_one->description_one ?? null !!}</textarea>
                            </div>
                        </div>
                    </form>
                </div>
