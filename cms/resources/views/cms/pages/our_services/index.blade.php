                    ...
                    <div class="widget-content widget-content-area">
                        ...
                        <div id="toggleAccordion">
                            ...
                            <div class="row">
                                <div class="col-md-11">
                                    <div class="card">
                                        ...
                                        <div id="sectionOne" class="collapse" aria-labelledby="..." data-parent="#toggleAccordion">
                                            <br>
                                            <table id="ourServicesSectionOneDatatable" class="table table-bordered table-hover table-condensed mb-4"" width="100%" cellspacing="0"
                                            cellpadding="0">
                                ...
                                <div class="col-md-1">
                                    <a href="{{route('our_services_section_one.create')}}" class="btn btn-dark mb-2 ml-1 mr-4 mt-2"> Add</a>
                                </div>
                            </div>
                            <!-- End Section One -->
...
@include('cms.pages.our_services.section_one.includes.our-services-section-one-js')
    <script>
