<script type="text/javascript">
    $(document).ready(function() {
      ...
      var table = $('#homeSectionFiveDatatable').DataTable({
          processing: true,
          serverSide: true,
          ajax: "{{ route('home_section_five.datatable') }}",
          "columns": [{
                  "data": "id",
                  "defaultContent": ""
              },
          ...
          "columnDefs": [{
              ...
              },
              {
                  ...
                  "render": function(data, type, row, meta) {
                      ...
                      var edit = "{{ route('home_section_five.edit', [':id']) }}";
          ...
          $('.section-six-status').change(function () {
            ...
            axios
              .post('{{route("home_section_five.status")}}', {
                _token: '{{csrf_token()}}',
                _method: 'patch',
                id: id,
                status: status,
          ...
          $('.section-six-delete').click(function () {
            ...
            swal({
              ...
              if (result.value) {
              axios
                .post('{{route("home_section_five.destroy")}}', {
                  _method: 'delete',
                  _token: '{{csrf_token()}}',
                  deleteId: deleteId,
                })
