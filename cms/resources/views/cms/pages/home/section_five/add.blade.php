    ...
    <div id="content" class="main-content">
        <div class="layout-px-spacing">
            <div class="row layout-top-spacing" id="cancel-row">
                ...
                <form action="{{ $isEdit ? route('home_section_five.update', [$home_section_five->id]) : route('home_section_five.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @if ($isEdit)
                    ...
                    <div class="widget-content widget-content-area">
                        <div class="form-row mb-4">
                            <div class="col-md-2">
                                ...
                                <input {{!$isEdit ? 'required' : null}} type="file" name="icon"  class="file" accept="image/*" >
                                <div class="images">
                                    <div class="photo">
                                        <img src="{{url('')}}/uploads/{{$home_section_five->image_one ?? 'placeholder-small.jpg'}}" id="preview" class="img-thumbnail browse">
                                    </div>
                                    @if ($errors->has('icon'))
                            ...
                            <div class="col-md-10">
                                <div class="row">
                                    <div class="col-md-3">
                                        ...
                                        <input type="number" name="figure" value="{{ $home_section_five->heading_one ?? old('name') ?? null }}"
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <input type="text" name="text" value="{{ $home_section_five->heading_two ?? old('text') ?? null }}"
