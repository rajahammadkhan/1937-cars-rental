                            ...
                            <div class="col-md-8">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="amount" value="{{ $home_section_six->heading_two ?? old('amount') ?? null }}"
                                    ...
                                    <div class="form-group col-md-12 mt10">
                                        <label for="">Countdown End Date <span class="text-danger"> * </span></label>
                                        <input type="date" name="date" value="{{ $home_section_six->date ?? old('date') ?? null }}"
