        ...
        <div class="layout-px-spacing">
            <div class="row layout-top-spacing" id="cancel-row">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('visa_service')}}">Visa Services</a></li>
                    ...
                    <div style="background: black;">
                        <div class="row">
                            <div class="col-md-6 mt15 pl30">
                                <h5 class="text-white">Update Content - {{$visa_service->name}}</h5>
                            </div>

                            <div class="col-md-6 text-right">
                                <a href="{{route('visa_service')}}" class="btn btn-danger mb-2 mr-4 ml-3 mt-2"> 
                    ...
                    <div class="widget-content widget-content-area">
                        ...
                        <div id="toggleAccordion">
                            <br>
                            @foreach($visa_service->details as $key => $detail)
                                <form action="{{route('visa_service.update', [$visa_service->id, $detail->id]) }}" method="POST">
                                @csrf
