                ...
                <form action="{{ $isEdit ? route('brand.update', [$brand->id]) : route('brand.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="widget-content widget-content-area">
                        <div class="form-row mb-4">
                            <!-- <div class="col-md-2">
                                <label>Logo <small>( Dimension : 75 x 75 )</small><span class="text-danger"> * </span></label>
                                <input type="file" name="logo"  class="file" accept="image/*" >
                                <div class="images">
                                    <div class="photo">
                                        <img src="{{url('')}}/uploads/{{$brand->logo ?? 'placeholder.png'}}" id="preview" class="img-thumbnail browse">
                                    </div>
                                </div>
                            </div> -->
