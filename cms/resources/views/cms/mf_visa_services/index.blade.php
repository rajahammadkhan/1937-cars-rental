                        ...
                        <div style="background: black;">
                            <div class="row">
                                <div class="col-md-6 mt15 pl30">
                                    <h5 class="text-white">Visa Services</h5>
                                </div>
                                @can('mf_visa_services-add')
                                    <div class="col-md-6 text-right">
                                        <a href="{{ route('mf_visa_service.create') }}" class="btn btn-danger mb-2 mr-4 ml-3 mt-2">Add Service</a>
                                    </div>
                                @endcan
                            </div>
                        </div>
...
@include('cms.mf_visa_services.includes.mf-visa-service-js')
@endsection
