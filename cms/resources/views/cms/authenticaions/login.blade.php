...
body {
  background:   url("{{url('')}}/uploads/login-bg-img.jpg") no-repeat center center;
  ...
  <div id="main" class="main-container">
    <div class="box">
      <div class="row mb-5 ml-1">
        <img src="{{url('')}}/uploads/1937_logo.png" width="300px" height="90px">
      ...
      <p class="text-center mt-4"> Copyright © 2021 | <a href="https://elitebiz.ae/" target="_blank">1937 Cars Rental</a></p>
    </div>
    </div>
  </div>
</div>
