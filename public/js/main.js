...
// 		$this.html(event.strftime('<div class="time-count"><span>4</span>Doors</div><div class="time-count"><span>%H</span>Hrs</div><div class="time-count"><span>%M</span>Mins</div><div class="time-count"><span>%S</span>Secs</div>'));
// 	});
// });
